...
draw = function(){
  ...
  if (answer == 1) {
    text("It is certain", 174, 229);
  };
  if(answer == 2){text("No",190, 229)}

if(answer == 3){text("Dont count on it",160, 229)}

if(answer == 4){text("Better not tell you now",145, 229)}
if(answer == 5){text("Absolutely not",165, 229)} 
if(answer == 6){
text("Unicorn!", 165, 229);
drawUnicorn(10, 300);
}

if(mousePressed)
 {text("rah",random(0,600),random(0,400));} 
};
